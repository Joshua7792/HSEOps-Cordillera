...
//
// The inner grid layout depends on CSS variables and grid-area rules that
// live in App.css (excel-heatmap-*). Only the outer chrome is Tailwind.
    ...
    >
      {rows.length === 0 ? (
        <section className="rounded-lg border border-[#30363d] bg-[#161b22] p-5">
          <p className="py-4 text-sm text-[#8b949e]">{t('heatmap.empty')}</p>
        </section>
      ) : (
        <section className="rounded-lg border border-[#30363d] bg-[#161b22] p-5">
